...
TEST_F(LibRadosIo, TooBig) {
  ...
  ASSERT_EQ(-E2BIG, rados_writesame(ioctx, "A", buf, UINT_MAX, 2, 0));
  ...
  ASSERT_EQ(-E2BIG, ioctx.writesame("foo", bl, UINT_MAX, 2, 0));
  ASSERT_EQ(-E2BIG, ioctx.writesame("foo", bl, 1, UINT_MAX, 0));
}
